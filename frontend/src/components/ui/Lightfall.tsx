...
/**
 * Lightfall (React Bits, ogl) — an animated WebGL field of falling light
 * streaks. Ported to TypeScript; the shader + render logic are unchanged.
 */
  ...
  useEffect(() => {
    ...
    const startLoop = () => {
      if (rafRef.current == null) {
        // Reset the damping clock so dt doesn't jump after a pause.
    ...
    // Pause the GPU render loop while the tab is hidden (saves battery/CPU) and
